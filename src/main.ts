...
//     logger.info("The garden fees: ", gardenFeeUsd);
//     logger.info("The garden time: ", gardenFeeUsd);
...
//     logger.info(`The results: ${filteredResults}`);
...
//     logger.info(
//       `The max fee saved: ${maxFeeDiff},\nthe time saved: ${formattedTimeSaved}`
//     );
